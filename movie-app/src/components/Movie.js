...
// Component to display data for a movie, the reviews and the review form
export default function Movie(props) {
  ...
  // Renders a movie, along with it's reviews and a new review form
  return (
    <div className="card border-dark my-4 mx-auto">
      <div className="card-header movie-color">
        <div className="container">
          <div className="row movie-header py-1">
            <div className="col-2 pt-1" id="synopsis">
              <img src={props.movie.img} alt="bloodsport" className="movie-img"/>
            </div>
            <div className="col-10 movie-middle">
              <h3>
                ...
                /><br/><br/>
              <div className="synopsis">{props.movie.synopsis}</div>
            </div>
          </div>
        </div>
      </div>
